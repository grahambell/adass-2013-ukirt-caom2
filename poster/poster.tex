...
\headerbox{Data Reduction Pipeline}{name=pipeline,column=0,span=2,below=intro,above=bottom}{
    \raggedright
...
\draw node[text width=1.5in, text ragged, font=\tiny] (mongo) {
...
\quad \quad \= \textcolor{listingfaint}{"\_id" :      ObjectId("5176688af9f5db5f13b83ee0"),} \\
            ...
            \> "headers" : [ \\
            \> \quad \quad \=   \{ \\
            \>             \> \quad \quad \= "AMSTART" :  \quad \= 1.047529, \\
            \>             \>             \> "AMEND" :    \> 1.047529, \\
            \>             \>             \> "INSTRUME" : \> "IRCAM3", \\
            \>             \>             \> "MODE" :     \> "ND\_STARE", \\
            \>             \>             \> "OBJECT" :   \> "HH111", \\
...
\quad \quad \= <\textcolor{listingfaint}{caom2:}collection>\textbf{UKIRT}</\textcolor{listingfaint}{caom2:}collection> \\
            ...
            \> <\textcolor{listingfaint}{caom2:}metaRelease>\textbf{1998-12-14T00:00:00.000}</\textcolor{listingfaint}{caom2:}metaRelease> \\
            \> <\textcolor{listingfaint}{caom2:}sequenceNumber>\textbf{10}</\textcolor{listingfaint}{caom2:}sequenceNumber> \\
            ...
            \> </\textcolor{listingfaint}{caom2:}algorithm> \\
            \> <\textcolor{listingfaint}{caom2:}type>\textbf{object}</\textcolor{listingfaint}{caom2:}type> \\
            \> <\textcolor{listingfaint}{caom2:}intent>\textbf{science}</\textcolor{listingfaint}{caom2:}intent> \\
            \> <\textcolor{listingfaint}{caom2:}target> \\
            \>             \> <\textcolor{listingfaint}{caom2:}name>\textbf{HH111}</\textcolor{listingfaint}{caom2:}name> \\
            \> </\textcolor{listingfaint}{caom2:}target> \\
            ...
            \>             \> <\textcolor{listingfaint}{caom2:}name>\textbf{IRCAM}</\textcolor{listingfaint}{caom2:}name> \\
            \>             \> <\textcolor{listingfaint}{caom2:}keywords> \\
            \>             \> \quad \quad \= pol=false magnifier=out detector\_mode=nd\_stare \\
            \>             \> </\textcolor{listingfaint}{caom2:}keywords> \\
            \> </\textcolor{listingfaint}{caom2:}instrument> \\
            \> <\textcolor{listingfaint}{caom2:}environment> \\
            \>             \> <\textcolor{listingfaint}{caom2:}elevation>\textbf{72.674337141}</\textcolor{listingfaint}{caom2:}elevation> \\
            \> </\textcolor{listingfaint}{caom2:}environment> \\
